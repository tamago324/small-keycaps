...
module keycap_outer_shape(key_bottom_size, key_top_size, key_top_height, angle, dish_depth, shift_upword) {
  difference() {
    // 基本的なキーキャップを作成
    base_cube(key_bottom_size, key_top_size, key_top_height, angle, shift_upword);
...
// 基本的なキーキャップを作成
module base_cube(key_bottom_size, key_top_size, key_top_height, angle, shift_upword) {
  hull() {
